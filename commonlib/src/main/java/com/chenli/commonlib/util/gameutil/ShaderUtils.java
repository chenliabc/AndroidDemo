package com.chenli.commonlib.util.gameutil;
...
public class ShaderUtils {
    ...
    /**
     * 编译链接
     * @param vertexShaderSource    源文件
     * @param fragmentShaderSource  源文件
     * @return
     */
    ...
    public static int[] loadTexture(Bitmap bitmap){
        ...
        if (textureId[0] != 0){
            ...
            //加载到opengl中后，就不需要bitmap了，回收掉bitmap
            bitmap.recycle();
            //生成mip贴图
            GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);
            //纹理加载完成，解除绑定,0表示解绑，防止其他纹理调用造成意外改变这个纹理
